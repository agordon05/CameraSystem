...
text_color: QtGui.QColor = QtGui.QColor(0, 0, 0)  # Black
table_selected_color: QtGui.QColor = QtGui.QColor("#505050")
button_color: QtGui.QColor = QtGui.QColor(Qt.GlobalColor.white)
...
# Table Type
exchange_table: int = 0
strategy_table: int = 1
associated_trade_table: int = 2
trade_table: int = 3


# Table Sort
exchange_status_order = {status_pending: 0, status_active: 1, status_inactive: 2, status_closed: 3}
strategy_status_order = {status_active: 0, status_closing: 1, status_inactive: 2, status_closed: 3}
trades_status_order = {status_pending: 0, status_active: 1, status_closing: 2, status_closed: 3}
...
# Strategy Types
strategy_types = ["Grid (Testing)", "Donate", "Testing"]
...
def format_label_center(widget: QtWidgets.QLabel):
    widget.setFont(page_data_font)
    widget.setStyleSheet(label_stylesheet)
    widget.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
